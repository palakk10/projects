...
<%
	...
	PreparedStatement ps=c.prepareStatement("select * from pathology where pname like '%"+searchString+"%'",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
	rs=ps.executeQuery();
	while(rs.next())
	{
		xray=rs.getString(1);
